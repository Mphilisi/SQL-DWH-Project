...
Script Purpose
	...
	--It truncate the bronze table before loading data.
	--It uses the BULK INSERT to load data from CSV files to bronze tables.

Parameters
	None.
	This Stored Procedure does not accept ant parameters or return any value.
